...
namespace {
const char *const clientCommunicationServiceName = "com.openlist.desktopclient.ClientCommunicationService";
...
Q_LOGGING_CATEGORY(lcFileProviderXPCUtils, "openlist.gui.macos.fileprovider.xpc.utils", QtInfoMsg)
