...
Q_LOGGING_CATEGORY(lcMoveJob, "openlist.sync.networkjob.move", QtInfoMsg)
Q_LOGGING_CATEGORY(lcPropagateRemoteMove, "openlist.sync.propagator.remotemove", QtInfoMsg)
